      ...
      <div class="container">
        ...
        <div id="middle-content">
          ...
          <div id="other-links">
            ...
            <a class="button-pill rounded shadow nx-console-jetbrains" href="https://plugins.jetbrains.com/plugin/21060-nx-console" target="_blank" rel="noreferrer">
...
nx run-many -t build test lint</pre>
          ...
          <details>
            ...
            <pre>nx show project kb-corporate-page</pre>
          </details>
