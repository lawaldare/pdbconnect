...
export const symmOperatorTooltip =
  'A unique identifier for chain copies generated by symmetry operations for the preferred assembly/complex. These identifiers distinguish the replicas created when building an assembly/complex from the asymmetric unit.';
...
export const MQTContentNavigationLinks = [
  {
