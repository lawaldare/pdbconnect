...
//         if (
//           alist[i].innerHTML.indexOf('<span class="link-' + fileTypes[type] + '"></span>') === -1 &&
...
//         searchBarButton.addEventListener(
//           'mouseenter',
//           function (event) {
...
//         // toggle the .embl-bar
//         var searchSelector = document.querySelectorAll('.search-toggle')[0].addEventListener(
//           'click',
//           function (event) {
...
//         var searchSelectorClose = document.querySelectorAll('.search-bar .close-button')[0].addEventListener(
//           'click',
//           function (event) {
//             event.preventDefault();
//             ebiToggleClass(searchBar, 'active');
...
//       '<div class="margin-bottom-large padding-top-xsmall margin-top-large"><h3 class="no-underline inline" style="line-height: 1rem;"><a href="//embl.org">EMBL</a></h3> was set up in 1974 as Europeâ€™s flagship laboratory for the life sciences â€“ an intergovernmental organisation with more than 80 independent research groups covering the spectrum of molecular biology:</div>' +
//       '</div>' +
...
//     var emblSelectorClose = document.querySelectorAll('.embl-bar .close-button')[0].addEventListener(
//       'click',
//       function (event) {
//         ebiToggleClass(emblBar, 'active');
//         ebiToggleClass(emblBarButton, 'active');
...
//     '<div class="column">' +
//     '<h5 class="services"><a class="" href="https://www.ebi.ac.uk/services">Services</a></h5><ul>' +
//     ' <li><a href="https://www.ebi.ac.uk/services/data-resources-and-tools">Data resources and tools</a></li> ' +
//     ' <li><a href="https://www.ebi.ac.uk/submission/">Data submission</a></li> ' +
//     ' <li class="last"><a href="https://www.ebi.ac.uk/support">Support and feedback</a></li> ' +
//     ' <li class="first"><a href="https://www.ebi.ac.uk/licencing">Licensing</a></li> ' +
//     '</ul></div>' +
//     '<div class="column">' +
//     '<h5 class="research"><a class="" href="https://www.ebi.ac.uk/research">Research</a></h5><ul>' +
//     ' <li><a href="https://www.ebi.ac.uk/research/publications">Publications</a></li> ' +
//     ' <li><a href="https://www.ebi.ac.uk/research/groups">Research groups</a></li> ' +
//     ' <li class="last"><a href="https://www.ebi.ac.uk/research/postdocs">Postdocs</a> and <a href="https://www.ebi.ac.uk/research/eipp">PhDs</a></li> ' +
//     '</ul></div>' +
//     '<div class="column"> ' +
//     '<h5 class="training"><a class="" href="https://www.ebi.ac.uk/training">Training</a></h5><ul>' +
//     ' <li><a href="https://www.ebi.ac.uk/training/live-events">Live training</a></li> ' +
//     ' <li><a href="https://www.ebi.ac.uk/training/on-demand">On-demand training</a></li> ' +
//     ' <li><a href="https://www.ebi.ac.uk/training/trainer-support">Support for trainers</a></li> ' +
//     ' <li><a href="https://www.ebi.ac.uk/training/contact-us">Contact organisers</a></li> ' +
//     '</ul></div> ' +
//     '<div class="column"> ' +
//     '<h5 class="industry"><a class="" href="https://www.ebi.ac.uk/industry">Industry</a></h5><ul>' +
//     ' <li><a href="https://www.ebi.ac.uk/industry/private/members-area/">Members Area</a></li> ' +
//     ' <li class="last"><a href="https://www.ebi.ac.uk/industry/contact-us">Contact Industry team</a></li> ' +
//     '</ul></div> ' +
//     '<div class="column"> ' +
//     '<h5 class="about"><a class="" href="https://www.ebi.ac.uk/about">About</a></h5><ul> ' +
//     ' <li><a href="https://www.ebi.ac.uk/about/contact">Contact us</a>' +
//     '<li><a href="https://www.ebi.ac.uk/about/events">Events</a></li> ' +
//     ' <li><a href="https://www.ebi.ac.uk/about/jobs" title="Jobs, postdocs, PhDs...">Jobs</a></li> ' +
//     ' <li class="first"><a href="https://www.ebi.ac.uk/about/news">News</a></li> ' +
//     ' <li><a href="https://www.ebi.ac.uk/about/people">People and groups</a></li> ' +
//     '</ul></div>' +
//     '</div>';
...
//   var html =
//     '<div class="columns">' +
//     '<p class="address">EMBL-EBI, Wellcome Genome Campus, Hinxton, Cambridgeshire, CB10 1SD, UK. +44 (0)1223 49 44 44</p> <p class="legal">Copyright &copy; EMBL ' +
//     d.getFullYear() +
//     ' | EMBL-EBI is <a href="http://www.embl.org/">part of the European Molecular Biology Laboratory</a> | <a href="https://www.ebi.ac.uk/about/terms-of-use">Terms of use</a>' +
...
//     document.getElementById('contentsarea');
//   if (container == null) {
...
//     'position: fixed; background: #707372; width: 100%; padding: .75rem 1%; left: 0; bottom: 0; border-top: 1px solid #373a36; color: #eee; z-index: 10;';
...
//       default:
//         console.warn(
//           'You should specify the targeted FrameworkVersion (allowed values: 1.1, 1.2, 1.3, 1.4, compliance, other). You sent: ' + targetedFrameworkVersion
//         );
//     }
