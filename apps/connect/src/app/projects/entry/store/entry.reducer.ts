...
const initialState: EntryStoreState = {
  ...
  resolutionValues: [],
  experimentalMethod: '',
  uniprotMapping: {} as UniProtMapping,
  uniprotCountsInPDBe: {},
  bestStructuresMappingsByUniProtIds: {},
  proteinPagesSummaryByUniProtIds: {},
  interproMapping: {} as InterProMappings,
  pfamMapping: {} as PfamMappings,
  downloadOptions: [],
  viewOptions: [],
  summaryQualityScores: {} as ProcessedQualityScores,
  cathMapping: {} as CathMappings,
  scop175Mapping: {} as ScopMappings,
  modifications: [],
