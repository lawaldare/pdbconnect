      ...
      .pipe(
        map((description) => {
          ...
          this.molProperties = [
            ...
            {
              name: 'Heavy atoms',
              value: `${properties.num_heavy_atoms.toFixed(1)}`,
              toolTip: 'Number of non-hydrogen atoms',
            },
            {
              name: 'Heteroatoms',
              value: `${properties.num_heteroatoms.toFixed(1)}`,
          ...
          this.confProperties = [
            {
              ...
              value: `${properties.num_rotatable_bonds.toFixed(1)}`,
          ...
          this.funProperties = [
            {
              ...
              value: `${properties.num_hbd.toFixed(1)}`,
              toolTip: `Number of hydrogen bond donors`,
            },
            {
              name: 'Hydrogen bond acceptors',
              value: `${properties.num_hba.toFixed(1)}`,
              toolTip: `Number of hydrogen bond acceptors`,
            },
            {
              name: 'Amide bonds',
              value: `${properties.num_amide_bonds.toFixed(1)}`,
          ...
          this.stereoProperties = [
            {
              name: 'Stereocenters',
              value: `${properties.num_atom_stereo_centers.toFixed(1)}`,
