...
export class ImageCarouselComponent implements AfterViewInit {
  ...
  private divsRendered: any[] = []; // eslint-disable-line @typescript-eslint/no-explicit-any
  private mainDivsRendered: any[] = []; // eslint-disable-line @typescript-eslint/no-explicit-any
