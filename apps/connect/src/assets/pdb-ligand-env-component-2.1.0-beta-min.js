...
class Depiction {
  ...
  getScale() {
    const e = this.atoms.map((e) => e.value).filter((e) => e > 0),
      t = d3.max(e),
      n = d3.min(e);
    return { radiusScale: d3.scaleSqrt([n, t], [10, 30]), colorScale: d3.scaleLinear([0, 0.01, t], ['#f0fcf0', '#a0bb9e', '#505d50']) };
  }
  appendBondVisuals() {
    this.structure
      .selectAll()
  ...
  highlightAtom(e) {
    ...
    const t = this.getScale(),
      n = d3.select(e).classed('selectedCircle', !0).style('stroke', '#FBBD1D').style('stroke-width', 5);
    !(function e() {
  ...
  fireExternalAtomEvent(e, t, n) {
    const i = new CustomEvent(n, { bubbles: !0, detail: { tooltip: e.toTooltip('%'), atomName: e.name, external: t } });
...
class Visualization {
  constructor(e, t, n = 'production', i = !1) {
    (this.dragHandler = d3
      .drag()
      .filter((e) => !e.static)
      .on('start', (e) => {
  ...
  initLigandWeights(e) {
    return __awaiter(this, void 0, void 0, function* () {
      const t = Resources.interactionAPI(e, this.environment);
  ...
  showWeights(e) {
    ...
    this.depiction.addCircles(t), void 0 !== this.zoomHandler && this.zoomHandler(this.svg, d3.zoomIdentity);
  }
  toggleDepiction(e) {
...
!(function (e) {
    ...
    filterOutAromaticAtomAtomInteractions(e) {
      ...
      for (const i of e) {
        ...
        if ('aromatic' === i.getLinkClass() && s) {
          let t = i.interaction.map((e) => e.targetAtoms);
          if (0 == t.length) continue;
          const n = t.reduce((e, t) => e.concat(t), []);
          let s = new Set(e.filter((e) => e.target.equals(i.target)));
          if (
            (s.delete(i),
            Array.from(s)
              .map((e) => e.interaction)
  ...
  e.LigandIntx = class {
    ...
    getAtomIntxPropensity() {
      ...
      return e.map((e) => ({ atom: e.atom, value: (e.count / t) * 100 }));
    }
  };
  class c {
    constructor(e, t) {
    ...
    customElements.define(
      ...
      class extends e.LitElement {
        ...
        renderLigandEnv() {
          ...
          this.depictionOnly ? (this.display = new Visualization(this, e, t, !0)) : (this.display = new Visualization(this, e, t, !1)),
            this.pdbId
              ? this.entityId
