...
class Depiction {
  ...
  highlightAtom(e) {
    ...
    const t = this.atoms,
      n = d3.scaleLinear([0, d3.max(t.map((e) => e.value))], [15, 30]);
    d3.select(e).classed('selectedCircle', !0).classed('isAnimating', !0).style('stroke', '#FBBD1D').style('stroke-width', 5),
      (function e() {
        d3.select('.selectedCircle').classed('isAnimating') &&
          d3
            .select('.selectedCircle')
            .transition()
            .duration(500)
            .style('stroke-width', 10)
            .attr('r', (e) => 1.3 * n(e.value))
            .transition()
            .duration(500)
  ...
  removeHighlights() {
    const e = this.atoms,
      t = d3.scaleLinear([0, d3.max(e.map((e) => e.value))], [15, 30]);
    d3.selectAll('.selectedCircle')
      .classed('selectedCircle', !1)
      .classed('isAnimating', !1)
      .interrupt()
      .attr('r', (e) => t(e.value))
      .style('stroke', null);
  }
