...
!(function (e) {
  (e.nodeSize = 30),
    (e.interactionClickEvent = 'PDB.interactions.click'),
    (e.interactionMouseoverEvent = 'PDB.interactions.mouseover'),
    (e.interactionMouseoutEvent = 'PDB.interactions.mouseout'),
    (e.interactionShowLabelEvent = 'PDB.interactions.showLabel'),
    (e.interactionHideLabelEvent = 'PDB.interactions.hideLabel'),
    (e.LigandShowAtomEvent = 'PDB.ligand.showAtom'),
    (e.LigandHideAtomEvent = 'PDB.ligand.hideAtom'),
    (e.molstarClickEvent = 'PDB.molstar.click'),
    (e.molstarMouseoverEvent = 'PDB.molstar.mouseover'),
    (e.molstarMouseoutEvent = 'PDB.molstar.mouseout'),
...
class Depiction {
  constructor(e, t, n) {
    ...
    n.bonds.forEach((e) => {
      let t = this.atoms.find((t) => t.name == e.bgn),
        ...
        s = new Bond(t, n, e.coords, e.style),
        o = [t.name, n.name].sort().join('_');
      i.has(o) || (i.add(o), t.connectivity++, n.connectivity++), this.bonds.push(s);
    });
  }
  getInitalNodePosition(e) {
    if (1 === this.atoms.length) return new Vector2D(this.atoms[0].position.x, this.atoms[0].position.y);
    let t = this.atoms.filter((t) => e.includes(t.name)).sort((e, t) => e.connectivity - t.connectivity)[0],
      n = this.bonds.find((e) => e.containsAtom(t)).getOtherAtom(t),
      i = n.position.x - 2 * (n.position.x - t.position.x),
      s = n.position.y - 2 * (n.position.y - t.position.y);
    return new Vector2D(i, s);
  }
  draw(e = !1) {
  ...
  highlightSubgraph(e, t) {
    if (this.atoms && (this.highlight.selectAll('*').remove(), e)) {
      ...
      let i = this.bonds.filter((t) => e.includes(t.bgn.name) && e.includes(t.end.name));
      this.highlight
        .selectAll()
        .data(i)
        .enter()
  ...
  addCircles(e, t) {
    this.atoms.forEach((t) => {
      t.value = e.filter((e) => e.atom == t.name).map((e) => e.value)[0];
    });
    const n = this.atoms.filter((e) => e.value > 0),
      i = e.map((e) => e.value),
      ...
      .each(function (e) {
        e.value >= o &&
          (d3
            ...
            .attr('r', l.radiusScale(e.value))
            .attr('fill', l.colorScale(e.value))
          ...
          e.value >= r &&
            d3
              ...
              .attr('cx', e.position.x)
              .attr('cy', e.position.y)
              .attr('r', d.radiusScale(e.value))
              .attr('fill', d.colorScale(e.value))
              .attr('fill-opacity', '0.5'));
      }),
      this.weight
        .selectAll()
        ...
        .attr('fill-opacity', '0.5')
        .on('mouseenter', (e) => this.atomMouseEnterEventHandler(e, !0))
        .on('mouseleave', () => this.atomMouseLeaveEventHandler(!0));
  }
  appendBondVisuals() {
    this.structure
      .selectAll()
    ...
    this.structure
      ...
      .each(function (e) {
        for (var t = 0; t < e.labels.length; t++)
          d3.select(this).append('path').attr('d', e.labels[t].d).style('background-color', 'white').attr('fill', e.labels[t].fill);
      });
  }
  getCenter(e) {
    let t = new Array();
    ...
    let n = d3.sum(t, (e) => e.x) / t.length,
      i = d3.sum(t, (e) => e.y) / t.length;
    return new Vector2D(n, i);
  }
  sortMap(e) {
    let t = [...e.values()].sort(),
      n = new Map();
  ...
  atomMouseEnterEventHandler(e, t) {
    this.fireExternalAtomEvent(e, t, Config.LigandShowAtomEvent);
  }
  atomMouseLeaveEventHandler(e) {
    this.fireExternalNullEvent(e, Config.LigandHideAtomEvent);
  }
  fireExternalAtomEvent(e, t, n) {
    const i = new CustomEvent(n, { bubbles: !0, detail: { tooltip: e.toTooltip(), external: t } });
    this.parent.dispatchEvent(i);
  }
...
class Atom {
  constructor(e) {
    (this.name = e.name), (this.labels = e.labels), (this.position = new Vector2D(e.x, e.y)), (this.connectivity = 0), (this.value = 0);
  }
  equals(e) {
    return e instanceof Atom && e.name === this.name;
  }
  toTooltip() {
...
class Vector2D {
  ...
  equals(e) {
    return e instanceof Vector2D && this.x == e.x && this.y == e.y;
  }
  distanceTo(e) {
    return Math.sqrt(Math.pow(e.x - this.x, 2) + Math.pow(e.y - this.x, 2));
  }
  static composeVectors(e) {
    let t = d3.sum(e.map((e) => e.x)),
      n = d3.sum(e.map((e) => e.y));
    return new Vector2D(t, n);
  }
}
class Bond {
  constructor(e, t, n, i) {
    (this.bgn = e), (this.end = t), (this.coords = n), (this.style = i.replace('stroke-width:2px', 'stroke-width:4px'));
  }
  getOtherAtom(e) {
...
class Visualization {
  constructor(e, t, n = 'production') {
    (this.dragHandler = d3
      .drag()
      .filter((e) => !e.static)
      .on('start', (e) => {
        d3.event.active || this.simulation.alphaTarget(0.3).restart(), (e.fx = e.x), (e.fy = e.y);
      })
      .on('drag', (e) => {
        (this.nodeDragged = !0), (e.fx = d3.event.x), (e.fy = d3.event.y);
      })
      .on('end', (e) => {
        (this.nodeDragged = !1), d3.event.active || this.simulation.alphaTarget(0), (e.fx = d3.event.x), (e.fy = d3.event.y);
      })),
      (this.parent = e),
      ...
      new UI(this.parent, this).register(t),
      (this.svg = d3
        .select(this.parent)
        .append('div')
  ...
  molstarClickEventHandler(e) {
    ...
    null === (t = this.nodes) ||
      void 0 === t ||
      t.each((e, t, i) => {
        if ((this.nodeDim(e, t, i), e.id === n)) return (this.selectedResidueHash = n), void this.nodeHighlight(e, t, i);
      });
  }
  ligHeatmapMouseoverEventHandler(e) {
    ...
    n.length > 0 ? this.depiction.atomMouseEnterEventHandler(n[0], !0) : this.depiction.atomMouseLeaveEventHandler(!1);
  }
  ...
  linkMouseOverEventHandler(e, t, n) {
    this.nodeDragged || (this.linkHighlight(e, t, n), this.fireExternalLinkEvent(e, Config.interactionMouseoverEvent));
  }
  linkMouseOutEventHandler(e, t, n) {
    this.nodeDragged || (this.linkDim(e, t, n), this.fireExternalNullEvent(Config.interactionMouseoutEvent));
  }
  nodeMouseoverEventHandler(e, t, n) {
    this.nodeDragged || (this.nodeHighlight(e, t, n), this.fireExternalNodeEvent(e, Config.interactionMouseoverEvent));
  }
  nodeMouseoutEventHandler(e, t, n) {
    var i, s;
    this.nodeDragged || (this.nodeDim(e, t, n), this.fireExternalNullEvent(Config.interactionMouseoutEvent)),
      null === (i = this.links) || void 0 === i || i.attr('opacity', 1),
      null === (s = this.nodes) || void 0 === s || s.attr('opacity', 1);
  }
  initBoundMoleculeInteractions(e, t) {
    this.pdbId = e;
    let n = Resources.boundMoleculeAPI(e, t, this.environment);
    d3.json(n)
      .catch((e) => this.processError(e, 'No interactions data are available.'))
      .then((e) => this.addBoundMoleculeInteractions(e, t))
      .then(() => new Promise((e) => setTimeout(e, 1500)))
      .then(() => this.centerScene());
  }
  initCarbohydratePolymerInteractions(e, t, n) {
    this.pdbId = e;
    let i = Resources.carbohydratePolymerAPI(e, t, n, this.environment);
    d3.json(i)
      .catch((e) => this.processError(e, 'No interactions data are available.'))
      .then((e) => this.addBoundMoleculeInteractions(e, t))
      .then(() => new Promise((e) => setTimeout(e, 1500)))
  ...
  initLigandInteractions(e, t, n, i = !1) {
    this.pdbId = e;
    let s = Resources.ligandInteractionsAPI(e, n, t, this.environment);
    d3.json(s)
      .catch((e) => this.processError(e, 'No interactions data are available.'))
      .then((e) => this.addLigandInteractions(e, i))
      .then(() => new Promise((e) => setTimeout(e, 1500)))
      .then(() => this.centerScene());
  }
  initLigandDisplay(e, t = !1) {
    return __awaiter(this, void 0, void 0, function* () {
      const n = Resources.ligandAnnotationAPI(e, this.environment);
      return d3
        .json(n)
  ...
  initLigandWeights(e) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return d3.json(t).then((e) => (this.ligandIntxData = e));
    });
  }
  addDepiction(e, t) {
    (this.depiction = new Depiction(this.parent, this.depictionRoot, e)), this.depiction.draw(t);
  }
  showWeights(e) {
    if (void 0 === this.depiction || void 0 === this.ligandIntxData) return;
    const t = new Model.LigandIntx(this.ligandIntxData, e).getAtomIntxPropensity();
    this.depiction.addCircles(t, 'Greens'), void 0 !== this.zoomHandler && this.zoomHandler(this.svg, d3.zoomIdentity);
  }
  toggleDepiction(e) {
  ...
  addLigandInteractions(e, t = !1) {
    let n = Object.keys(e)[0],
      i = e[n][0];
    (this.interactionsData = e),
      void 0 === this.depiction || this.depiction.ccdId !== i.ligand.chem_comp_id
        ? this.initLigandDisplay(i.ligand.chem_comp_id, t).then(() => {
            (this.presentBindingSite = new Model.BindingSite().fromLigand(n, i, this.depiction)),
  ...
  addBoundMoleculeInteractions(e, t) {
    let n = Object.keys(e)[0];
    (this.interactionsData = e),
      (this.presentBindingSite = new Model.BindingSite().fromBoundMolecule(n, e[n][0])),
      this.bindingSites.push(this.presentBindingSite),
      (this.presentBindingSite.bmId = t);
    let i = this.presentBindingSite.residues.filter((e) => e.isLigand);
    1 === i.length ? this.initLigandInteractions(this.pdbId, i[0].authorResidueNumber, i[0].chainId) : this.setupScene();
  }
  saveSvg() {
    d3.text(Resources.ligEnvCSSAPI(this.environment)).then((e) => {
      ...
      (s.href = i), (s.download = this.getSVGName()), document.body.appendChild(s), s.click(), document.body.removeChild(s);
    });
  }
  ...
  centerScene() {
    if (void 0 !== this.nodes) {
      let e = d3.min(this.nodes.data().map((e) => e.x)),
        t = d3.min(this.nodes.data().map((e) => e.y)),
        n = d3.max(this.nodes.data().map((e) => e.x)),
  ...
  resize() {
    this.svg.attr('width', this.parent.offsetWidth).attr('height', this.parent.offsetHeight),
      void 0 === this.depiction
        ? this.simulation.force('center', d3.forceCenter(this.parent.offsetWidth / 2, this.parent.offsetHeight / 2)).restart()
        : this.simulation.restart(),
      void 0 !== this.zoomHandler && this.zoomHandler(this.svg);
  }
  getSVGName() {
    return void 0 !== this.presentBindingSite ? `${this.presentBindingSite.bmId}.svg` : void 0 !== this.depiction ? `${this.depiction.ccdId}.svg` : 'blank.svg';
  }
  nullNodesPositions() {
    this.presentBindingSite.interactionNodes.forEach((e) => {
      e.static || ((e.fx = null), (e.fy = null));
    });
  }
  fireExternalLinkEvent(e, t) {
    let n = [],
      i = [];
    if (e instanceof Model.LigandResidueLink) {
      let t = [].concat.apply(
        [],
        e.interaction.map((e) => e.sourceAtoms)
      );
      n = [].concat.apply([], t).filter((e, t, n) => n.indexOf(e) === t);
      let s = [].concat.apply(
        [],
        e.interaction.map((e) => e.targetAtoms)
      );
      i = [].concat.apply([], s).filter((e, t, n) => n.indexOf(e) === t);
    }
  ...
  setupLinks() {
    (this.links = this.linksRoot.selectAll().data(this.presentBindingSite.links).enter().append('g')),
      this.links
        ...
        .on('mouseenter', (e, t, n) => this.linkMouseOverEventHandler(e, t, n))
        .on('mouseleave', (e, t, n) => this.linkMouseOutEventHandler(e, t, n)),
      this.links
        .append('line')
  ...
  selectLigand(e, t, n) {
    this.fireExternalNodeEvent(e, Config.interactionClickEvent),
      e.residue.isLigand &&
        (this.nodeDim(e, t, n),
  ...
  setupLigandScene() {
    return __awaiter(this, void 0, void 0, function* () {
      this.wipeOutVisuals(),
        ...
        this.presentBindingSite.interactionNodes
          ...
          .forEach((e) => {
            let t = this.presentBindingSite.links.filter((t) => t.containsNode(e) && 'hydrophobic' !== t.getLinkClass()),
              ...
              i = [].concat.apply([], n),
              s = this.depiction.getInitalNodePosition(i);
        ...
        yield Promise.all(this.rProvider.downloadPromises),
        yield Promise.all([this.visualsMapper.graphicsPromise, this.visualsMapper.mappingPromise]),
        ...
        this.nodes
          ...
          .on('mouseenter', (e, t, n) => this.nodeMouseoverEventHandler(e, t, n))
          .on('mouseleave', (e, t, n) => this.nodeMouseoutEventHandler(e, t, n)),
        this.nodes
        ...
        this.nodes
          ...
          .append('circle')
          .attr('r', (e) => e.scale * Config.nodeSize);
      ...
      let t = d3
          ...
          .distance(5),
        n = d3.forceManyBody().strength(-80).distanceMin(10).distanceMax(20),
        i = d3.forceCollide(50).iterations(10).strength(0.5);
      (this.simulation = d3
        .forceSimulation(this.presentBindingSite.interactionNodes)
        .force('link', t)
        .force('charge', n)
        .force('collision', i)
        .on('tick', () => this.simulationStep())),
        this.dragHandler(this.nodes),
        void 0 !== this.zoomHandler && this.zoomHandler(this.svg, d3.zoomIdentity);
    });
  }
  setupScene() {
    return __awaiter(this, void 0, void 0, function* () {
      this.wipeOutVisuals(),
        ...
        (this.nodes = this.nodesRoot
          ...
          .append('g')
          .attr('class', (e) => `pdb-lig-env-svg-node pdb-lig-env-svg-${e.residue.getResidueType()}-res`)
          .on('click', (e, t, n) => this.selectLigand(e, t, n))
          .on('mouseover', (e, t, n) => this.nodeMouseoverEventHandler(e, t, n))
          .on('mouseout', (e, t, n) => this.nodeMouseoutEventHandler(e, t, n))),
        this.nodes.filter((e) => this.visualsMapper.glycanMapping.has(e.residue.chemCompId)).html((e) => this.visualsMapper.getGlycanImage(e.residue.chemCompId)),
        this.nodes
          .filter((e) => !this.visualsMapper.glycanMapping.has(e.residue.chemCompId))
          .append('circle')
      ...
      let e = d3
          ...
          .strength(0.5),
        t = d3.forceManyBody().strength(-1e3).distanceMin(55).distanceMax(250),
        n = d3.forceCollide(45),
        i = d3.forceCenter(this.parent.offsetWidth / 2, this.parent.offsetHeight / 2);
      (this.simulation = d3
        .forceSimulation(this.presentBindingSite.interactionNodes)
        .force('link', e)
        .force('charge', t)
  ...
  nodeHighlight(e, t, n) {
    (e.scale = 1.5),
      e.residue.isLigand && d3.select(n[t]).style('cursor', 'pointer'),
      d3.select(n[t]).attr('transform', () => `translate(${e.x},${e.y}) scale(${e.scale})`);
    let i = [e];
    this.links
      ...
      this.nodes.filter((e) => !i.includes(e)).attr('opacity', 0.4),
      this.links.filter((t) => !t.containsNode(e)).attr('opacity', 0.4);
  }
  nodeDim(e, t, n) {
    e.static || (e.scale = 1),
      e.residue.isLigand && d3.select(n[t]).style('cursor', 'default'),
      d3.select(n[t]).attr('transform', `translate(${e.x},${e.y}) scale(${e.scale})`);
  }
  linkHighlight(e, t, n) {
    let i = d3.select(n[t]).node().parentNode;
    d3.select(i).classed('pdb-lig-env-svg-bond-highlighted', !0),
      this.links.filter((t) => t !== e).attr('opacity', 0.4),
      this.nodes.filter((t) => !(t === e.source || t === e.target)).attr('opacity', 0.4);
  }
  linkDim(e, t, n) {
    let i = d3.select(n[t]).node().parentNode;
    d3.select(i).classed('pdb-lig-env-svg-bond-highlighted', !1),
      this.links.filter((t) => t !== e).attr('opacity', 1),
      this.nodes.filter((t) => !(t === e.source || t === e.target)).attr('opacity', 1);
  }
  showLigandLabel(e) {
    const t = new CustomEvent(Config.interactionShowLabelEvent, { bubbles: !0, detail: { label: e.toTooltip() } });
    this.parent.dispatchEvent(t);
  }
  addMarkers() {
  ...
  parseEnvironment(e) {
    let t = void 0;
    if (void 0 === e) t = Model.Environment.Production;
    else
      switch ((e = e.toLowerCase())) {
        case 'production':
        case 'prod':
          t = Model.Environment.Production;
          break;
        case 'development':
        case 'dev':
          t = Model.Environment.Development;
          break;
        case 'internal':
        case 'int':
          t = Model.Environment.Internal;
          break;
        default:
          console.log(`Unknown environment ${e}. Using production instead.`), (t = Model.Environment.Production);
      }
    return t;
  }
}
!(function (e) {
  ...
  })((t = e.InteractionType || (e.InteractionType = {}))),
    (function (e) {
      (e[(e.Production = 0)] = 'Production'), (e[(e.Development = 1)] = 'Development'), (e[(e.Internal = 2)] = 'Internal');
    })((n = e.Environment || (e.Environment = {})));
  class i {
    static parse(e) {
      if ('atom_atom' === e) return t.AtomAtom;
      if ('atom_plane' === e) return t.AtomPlane;
      if ('plane_plane' === e) return t.PlanePlane;
      if ('group_plane' === e) return t.GroupPlane;
      if ('group_group' === e) return t.GroupGroup;
      throw `Interaction type ${e} does not exist`;
    }
  }
  e.InteractionTypeUtil = i;
  class s {
    constructor(e, t, n, i, s) {
      (this.sourceAtoms = e), (this.targetAtoms = t), (this.interactionType = n), (this.interactionsClases = i), (this.distance = s);
    }
  }
  e.Interaction = s;
  class o {
    ...
    getResidueType() {
      ...
      let e = ResidueProvider.getInstance().getAminoAcidAbbreviation(this.chemCompId);
      for (let [t, n] of Config.aaTypes) if (n.includes(e)) return t;
      return 'other';
    }
    equals(e) {
      return e instanceof o && this.id === e.id;
    }
    toString() {
      return this.id;
    }
  ...
  class r {
    constructor(e, t, n, i, s) {
      (this.residue = e),
        ...
        (this.scale = t),
        void 0 !== i && ((this.fx = i), (this.x = i)),
        void 0 !== s && ((this.fy = s), (this.y = s));
    }
    equals(e) {
      return e instanceof r && this.id === e.id && this.fx == e.fx && this.fy == e.fy;
    }
    toString() {
      let e = this.residue,
        t = e.chainId.split('_'),
        n = t[0],
        i = '';
      return t.length > 1 && (i = '1' !== t[1] ? `[${t[1]}]` : ''), `${e.chemCompId} | ${n}${i} | ${e.authorResidueNumber}${e.authorInsertionCode}`;
    }
    toTooltip() {
  ...
  class a {
    ...
    containsBothNodes(e, t) {
      let n = this.source.equals(e) && this.target.equals(t),
        i = this.source.equals(t) && this.target.equals(e);
      return n || i;
    }
    containsNode(e) {
  ...
  class l extends a {
    ...
    getLinkClass() {
      ...
      for (let [e, t] of Config.interactionsClasses) for (let n of this.interactions.values()) if (n.filter((e) => -1 !== t.indexOf(e)).length > 0) return e;
      return 'other';
    }
  }
  ...
  class d extends a {
    ...
    getLinkClass() {
      ...
      for (let [t, n] of Config.interactionsClasses) if (e.filter((e) => -1 !== n.indexOf(e)).length > 0) return t;
      return 'other';
    }
    hasClash() {
      return (
    ...
    toTooltip() {
      let e = new Set(),
        t = ResidueProvider.getInstance();
      return (
        this.interaction.forEach((n) => {
          let i = !this.target.residue.isLigand && n.targetAtoms.every((e) => Config.backboneAtoms.includes(e)),
            s = t.getAminoAcidAbbreviation(this.target.residue.chemCompId),
            o = Boolean('X' !== s),
            r = '';
          (r = i && o ? 'backbone' : !i && o ? 'side chain' : 'ligand'),
            e.add(`<li><span>${r}</span> interaction (<b>${n.targetAtoms}</b> | ${n.interactionsClases}): ${n.distance}Å</li>`);
        }),
  ...
  e.BindingSite = class {
      ...
      return (
        t.composition.connections.forEach((e) => {
          let t = n.find((t) => t.residue.id === e[0]),
            i = n.find((t) => t.residue.id === e[1]);
          if (void 0 === this.links.find((e) => e.containsBothNodes(t, i))) {
            let e = new l(t, i, { atom_atom: ['covalent'] });
            this.links.push(e);
          }
        }),
    ...
    processResidueInteractionPartner(e) {
      ...
      let n = new r(t, 1, t.id);
      return (n = this.tmpNodesSet.tryAdd(n));
    }
    processLigandInteractionPartner(e, t, n) {
      let i = 0;
      i = e.isLigand ? (n.length > 1 ? 0.5 : 0) : 1;
      let s = t.getCenter(n),
        o = `${e.id}_${n.sort().reduce((e, t) => e + '_' + t)}`,
        a = new r(e, i, o, s.x, s.y);
      return (a = this.tmpNodesSet.tryAdd(a));
    }
    fromLigand(e, t, n) {
      (this.pdbId = e),
      ...
      return (
        ...
        t.interactions.forEach((e) => {
          let t = this.processLigandInteractionPartner(s, n, e.ligand_atoms),
            o = this.processResidueInteractionPartner(e.end);
          if (t.residue.equals(o.residue)) return void this.tmpNodesSet.delete(o);
          let r = i.find((e) => e.containsBothNodes(t, o));
          if (void 0 !== r) r.addInteraction(e.ligand_atoms, e.end.atom_names, e.interaction_type, e.interaction_details, e.distance);
          else {
            let n = new d(t, o, e.ligand_atoms, e.end.atom_names, e.interaction_type, e.interaction_details, e.distance);
            i.push(n);
          }
        }),
        (this.interactionNodes = Array.from(this.tmpNodesSet)),
        (this.links = this.filterOutAromaticAtomAtomInteractions(i)),
        this
      );
    }
    filterOutAromaticAtomAtomInteractions(e) {
      ...
      return (
        e.forEach((i) => {
          ...
          if ('aromatic' === i.getLinkClass() && s) {
            let t = i.interaction.map((e) => e.targetAtoms).reduce((e, t) => e.concat(t)),
              n = new Set(e.filter((e) => e.target.equals(i.target)));
            if (
              (n.delete(i),
              Array.from(n)
                .map((e) => e.interaction)
  ...
  e.LigandIntx = class {
    ...
    getFilteredData() {
      const e = new Array();
      for (const t in this.data) this.contactTypes.includes(t) && e.push(...this.data[t].map(this.getAtomResidueObj));
      return e;
    }
    getAtomIntxPropensity() {
      ...
      return e.map((e) => ({ atom: e.atom, value: (e.count / t).toFixed(2) }));
    }
  };
  class c {
    constructor(e, t) {
  ...
  e.Gradient = class {
    ...
    getScales() {
      const e = d3[`scheme${this.colorScheme}`][9],
        t = Number(d3.max(this.weight));
      return {
        firstScale: new c(d3.scaleLinear([0, t], [20, 30]), d3.scaleLinear([0, t], ['#FFFFFF', e[4]])),
        secondScale: new c(d3.scaleLinear([0, t], [10, 20]), d3.scaleLinear([0, t], [e[5], e[7]])),
        thirdScale: new c(d3.scaleLinear([0, t], [2, 10]), d3.scaleLinear([0, t], [e[8], e[9]])),
      };
    }
  };
})(Model || (Model = {}));
...
class ResidueProvider {
  ...
  downloadAnnotation(e) {
    ...
    let t = Resources.residueTypeAPI(e.chemCompId, this.environment),
      n = d3.json(t).then((t) => {
...
!(function (e) {
  (e.productionAPI = 'https://www.ebi.ac.uk/pdbe'),
    (e.devAPI = 'https://wwwdev.ebi.ac.uk/pdbe'),
    (e.intAPI = 'https://wwwint.ebi.ac.uk/pdbe'),
    (e.boundMoleculeURL = 'graph-api/pdb/bound_molecule_interactions'),
    (e.carbohydrateURL = 'graph-api/pdb/carbohydrate_polymer_interactions'),
    (e.boundLigandURL = 'graph-api/pdb/bound_ligand_interactions'),
    ...
    (e.glycanSymbolsAPI = function (t) {
      ...
      switch (t) {
        ...
        case Model.Environment.Development:
          n = `${e.devAPI}/${e.componentLibraryURL}/pdb-snfg-visuals.xml`;
          break;
        default:
          n = `${e.productionAPI}/${e.componentLibraryURL}/pdb-snfg-visuals.xml`;
      }
      return n;
    }),
    (e.hetMappingAPI = function (t) {
      let n = '';
      switch (t) {
        case Model.Environment.Internal:
        case Model.Environment.Development:
          n = `${e.devAPI}/${e.componentLibraryURL}/het_mapping.json`;
          break;
        default:
          n = `${e.productionAPI}/${e.componentLibraryURL}/het_mapping.json`;
      }
      return n;
    }),
    (e.ligEnvCSSAPI = function (t) {
      let n = '';
      switch (t) {
        case Model.Environment.Internal:
        case Model.Environment.Development:
          n = `${e.devAPI}/pdb-component-library/css/pdb-ligand-env-svg.css`;
          break;
        default:
          n = `${e.productionAPI}/pdb-component-library/css/pdb-ligand-env-svg.css`;
      }
      return n;
    }),
    (e.ligandAnnotationAPI = function (t, n) {
      let i = '';
      switch (n) {
        case Model.Environment.Production:
          i = `${e.productionAPI}/${e.staticFilesURL}/${t}/annotation`;
          break;
        case Model.Environment.Development:
        case Model.Environment.Internal:
          i = `${e.devAPI}/${e.staticFilesURL}/${t}/annotation`;
      }
      return i;
    }),
    (e.boundMoleculeAPI = function (t, n, i) {
      let s = '';
      switch (i) {
        case Model.Environment.Development:
          s = `${e.devAPI}/${e.boundMoleculeURL}/${t}/${n}`;
          break;
        case Model.Environment.Internal:
          s = `${e.intAPI}/${e.boundMoleculeURL}/${t}/${n}`;
          break;
        default:
          s = `${e.productionAPI}/${e.boundMoleculeURL}/${t}/${n}`;
      }
      return s;
    }),
    (e.carbohydratePolymerAPI = function (t, n, i, s) {
      let o = '';
      switch (s) {
        case Model.Environment.Development:
          o = `${e.devAPI}/${e.carbohydrateURL}/${t}/${n}/${i}`;
          break;
        case Model.Environment.Internal:
          o = `${e.intAPI}/${e.carbohydrateURL}/${t}/${n}/${i}`;
          break;
        default:
          o = `${e.productionAPI}/${e.carbohydrateURL}/${t}/${n}/${i}`;
      }
      return o;
    }),
    (e.ligandInteractionsAPI = function (t, n, i, s) {
      let o = '';
      switch (s) {
        case Model.Environment.Development:
          o = `${e.devAPI}/${e.boundLigandURL}/${t}/${n}/${i}`;
          break;
        case Model.Environment.Internal:
          o = `${e.intAPI}/${e.boundLigandURL}/${t}/${n}/${i}`;
          break;
        default:
          o = `${e.productionAPI}/${e.boundLigandURL}/${t}/${n}/${i}`;
      }
      return o;
    }),
    (e.residueTypeAPI = function (t, n) {
      let i = '';
      switch (n) {
        case Model.Environment.Development:
          i = `${e.devAPI}/${e.compoundSummaryURL}/${t}`;
          break;
        case Model.Environment.Internal:
          i = `${e.intAPI}/${e.compoundSummaryURL}/${t}`;
          break;
        default:
...
class UI {
  ...
  register(e) {
    ...
    if (e.menu) {
      if (
        ...
        (n = t.append('div').classed('pdb-lig-env-menu-panel', !0).attr('id', 'pdb-lig-env-menu-dynamic-panel').style('display', 'none').style('opacity', 0)),
        e.help)
      ) {
        n.append('i')
        ...
        let e = d3.select(this.parent).append('div').attr('id', 'pdb-lig-env-help-container'),
        ...
        t
          ...
          e.append('div').attr('id', 'pdb-lig-env-help-ligands').html(helpLigands),
          e.append('div').attr('id', 'pdb-lig-env-help-bonds').html(helpBonds);
      }
      e.downloadImage &&
        n
          .append('i')
    ...
    e.tooltip && (this.tooltip = d3.select(this.parent).append('div').classed('pdb-lig-env-label', !0).attr('id', 'pdb-lig-env-tooltip').style('opacity', 0)),
      e.residueLabel &&
        (this.residueLabel = d3.select(this.parent).append('div').classed('pdb-lig-env-label', !0).attr('id', 'pdb-lig-env-residue-label').style('opacity', 0)),
      void 0 !== this.tooltip &&
  ...
  changeHelp(e) {
    let t = d3.select(this.parent).select('#pdb-lig-env-help-residues-btn'),
      n = d3.select(this.parent).select('#pdb-lig-env-help-bonds-btn'),
      i = d3.select(this.parent).select('#pdb-lig-env-help-bonds'),
      s = d3.select(this.parent).select('#pdb-lig-env-help-ligands');
    e
      ? (n.classed('active', !1), t.classed('active', !0), i.style('display', 'none'), s.style('display', 'block'))
      : (t.classed('active', !1), n.classed('active', !0), i.style('display', 'block'), s.style('display', 'none'));
  }
  showNames() {
    let e = d3.select(this.parent).select('#pdb-lig-env-names-btn');
    e.classed('active')
  ...
  showHelp() {
    let e = d3.select(this.parent).select('#pdb-lig-env-help-container'),
      t = d3.select(this.parent).select('#pdb-lig-env-help-btn');
  ...
  displayToolbarPanel(e) {
    let t = d3.select(this.parent).select('#pdb-lig-env-menu-dynamic-panel'),
      n = d3.select(this.parent).select('#pdb-lig-env-help-container');
    (t || n) && (e || 'block' === n.style('display') ? (t.style('display', 'block'), t.style('opacity', 0.9)) : (t.style('display', 'none'), t.style('opacity', 0)));
  }
  fullScreen() {
    let e = d3.select(this.parent).select('#pdb-lig-env-fullscreen-btn');
  ...
  nodeMouseEnterEventHandler(e) {
    this.tooltip.transition().duration(200).style('opacity', 0.9), this.tooltip.html(e.detail.tooltip);
  }
  nodeMouseLeaveEventHandler() {
    this.tooltip.transition().duration(200).style('opacity', 0);
  }
  showLigandLabel(e) {
    this.residueLabel.transition().duration(200).style('opacity', 0.9), this.residueLabel.html(e.detail.label);
  }
  hideLigandLabel() {
    this.residueLabel.transition().duration(200).style('opacity', 0);
  }
}
class VisualsMapper {
  constructor(e) {
    (this.glycanMapping = new Map()), (this.glycanImages = new Map());
    let t = Resources.glycanSymbolsAPI(e),
      n = Resources.hetMappingAPI(e);
    (this.graphicsPromise = this.parseSymbols(t)), (this.mappingPromise = this.parseGlycanMapping(n));
  }
  getGlycanImage(e) {
    return this.glycanMapping.has(e) ? this.glycanImages.get(this.glycanMapping.get(e)) : new SVGElement();
  }
  parseSymbols(e) {
    return __awaiter(this, void 0, void 0, function* () {
      return d3.xml(e).then((e) => {
  ...
  parseGlycanMapping(e) {
    return __awaiter(this, void 0, void 0, function* () {
      return d3.json(e).then((e) => {
...
(() => {
  var e = {
              ...
              return this.map(function (t) {
                var n = (function (e, t) {
                  ...
                  if (t && 'function' == typeof btoa) {
                    var s =
                        ((r = i), '/*# sourceMappingURL=data:application/json;charset=utf-8;base64,' + btoa(unescape(encodeURIComponent(JSON.stringify(r)))) + ' */'),
        ...
        e.exports = function (e) {
          ...
          return e.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (e, t) {
            ...
            return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(o)
              ? e
              : ((s = 0 === o.indexOf('//') ? o : 0 === o.indexOf('/') ? n + o : i + o.replace(/^\.\//, '')), 'url(' + JSON.stringify(s) + ')');
          });
        };
      },
      './node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[0].use[1]!./src/styles/pdb-ligand-env.css': (e, t, n) => {
      ...
      './src/styles/pdb-ligand-env.css': (e, t, n) => {
        var i = n('./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[0].use[1]!./src/styles/pdb-ligand-env.css');
        'string' == typeof i && (i = [[e.id, i, '']]);
        var s = { hmr: !0, transform: void 0, insertInto: void 0 };
        n('./node_modules/style-loader/lib/addStyles.js')(i, s);
      ...
      './node_modules/style-loader/lib/addStyles.js': (e, t, n) => {
        ...
        function c(e, t) {
          for (var n = 0; n < e.length; n++) {
            ...
            if (o) {
              ...
              for (; r < s.parts.length; r++) o.parts.push(v(s.parts[r], t));
            } else {
              var a = [];
              for (r = 0; r < s.parts.length; r++) a.push(v(s.parts[r], t));
        ...
        function h(e, t) {
          for (var n = [], i = {}, s = 0; s < e.length; s++) {
            ...
            i[r] ? i[r].parts.push(a) : n.push((i[r] = { id: r, parts: [a] }));
          }
          return n;
        }
        function p(e, t) {
        ...
        function v(e, t) {
          ...
          if (t.singleton) {
            var l = a++;
            (n = r || (r = m(t))), (i = y.bind(null, n, l, !1)), (s = y.bind(null, n, l, !0));
          } else
            e.sourceMap &&
            'function' == typeof URL &&
        ...
        function y(e, t, n, i) {
          var s = n ? '' : i.css;
          if (e.styleSheet) e.styleSheet.cssText = f(t, s);
          else {
      ...
      './node_modules/lit-element/lib/css-tag.js': (e, t, n) => {
        n.r(t), n.d(t, { CSSResult: () => o, css: () => a, supportsAdoptingStyleSheets: () => i, unsafeCSS: () => r });
        const i =
            window.ShadowRoot &&
        ...
        class o {
          ...
          get styleSheet() {
            return (
              void 0 === this._styleSheet && (i ? ((this._styleSheet = new CSSStyleSheet()), this._styleSheet.replaceSync(this.cssText)) : (this._styleSheet = null)),
              this._styleSheet
            );
          }
          toString() {
        ...
        const r = (e) => new o(String(e), s),
          a = (e, ...t) => {
            const n = t.reduce(
              (t, n, i) =>
                t +
                ((e) => {
                  if (e instanceof o) return e.cssText;
      ...
      './node_modules/lit-element/lib/decorators.js': (e, t, n) => {
        n.r(t),
          n.d(t, {
            ...
            eventOptions: () =>
              function (e) {
                return (t, n) => (void 0 !== n ? c(e, t, n) : d(e, t));
              },
            internalProperty: () =>
              function (e) {
                return r({ attribute: !1, hasChanged: null == e ? void 0 : e.hasChanged });
              },
            property: () => r,
            query: () =>
              function (e, t) {
            ...
            queryAssignedNodes: () =>
              function (e = '', t = !1, n = '') {
                return (i, s) => {
                  const o = {
                    get() {
                      const i = `slot${e ? `[name=${e}]` : ':not([name])'}`,
                        s = this.renderRoot.querySelector(i);
                      let o = s && s.assignedNodes({ flatten: t });
                      return o && n && (o = o.filter((e) => (e.nodeType === Node.ELEMENT_NODE && e.matches ? e.matches(n) : p.call(e, n)))), o;
                    },
                    enumerable: !0,
                    configurable: !0,
                  };
                  return void 0 !== s ? a(o, i, s) : l(o, i);
                };
              },
            queryAsync: () =>
              function (e) {
        ...
        function r(e) {
          return (t, n) => (void 0 !== n ? o(e, t, n) : s(e, t));
        }
        const a = (e, t, n) => {
            Object.defineProperty(t, n, e);
          },
          l = (e, t) => ({ kind: 'method', placement: 'prototype', key: t.key, descriptor: e }),
          d = (e, t) =>
            Object.assign(Object.assign({}, t), {
              finisher(n) {
        ...
        const h = Element.prototype,
          p = h.msMatchesSelector || h.webkitMatchesSelector;
      },
      './node_modules/lit-element/lib/updating-element.js': (e, t, n) => {
        n.r(t), n.d(t, { UpdatingElement: () => h, defaultConverter: () => i, notEqual: () => s }), (window.JSCompiler_renameProperty = (e, t) => e);
        const i = {
            toAttribute(e, t) {
              switch (t) {
                case Boolean:
          ...
          s = (e, t) => t !== e && (t == t || e == e),
          o = { attribute: !0, type: String, converter: i, reflect: !1, hasChanged: s },
          r = 1,
          a = 4,
          l = 8,
          d = 16,
        ...
        class h extends HTMLElement {
          ...
          static getPropertyDescriptor(e, t, n) {
            return {
              ...
              set(i) {
                const s = this[e];
                (this[t] = i), this.requestUpdateInternal(e, s, n);
              },
              configurable: !0,
              enumerable: !0,
            };
          ...
          static getPropertyOptions(e) {
            return (this._classProperties && this._classProperties.get(e)) || o;
          }
          static finalize() {
          ...
          static _propertyValueToAttribute(e, t) {
            ...
            const n = t.type,
              s = t.converter;
            return ((s && s.toAttribute) || i.toAttribute)(e, n);
          }
          initialize() {
            (this._updateState = 0),
          ...
          _attributeToProperty(e, t) {
            ...
            if (void 0 !== i) {
              ...
              (this._updateState = this._updateState | d), (this[i] = n._propertyValueFromAttribute(t, e)), (this._updateState = this._updateState & ~d);
            }
          }
      ...
      './node_modules/lit-element/lit-element.js': (e, t, n) => {
        n.r(t),
          n.d(t, {
            CSSResult: () => a.CSSResult,
            LitElement: () => d,
            SVGTemplateResult: () => r.SVGTemplateResult,
            TemplateResult: () => r.TemplateResult,
            UpdatingElement: () => s.UpdatingElement,
            css: () => a.css,
            customElement: () => o.customElement,
            defaultConverter: () => s.defaultConverter,
            eventOptions: () => o.eventOptions,
            html: () => r.html,
            internalProperty: () => o.internalProperty,
            notEqual: () => s.notEqual,
            property: () => o.property,
            query: () => o.query,
            queryAll: () => o.queryAll,
            queryAssignedNodes: () => o.queryAssignedNodes,
            queryAsync: () => o.queryAsync,
            supportsAdoptingStyleSheets: () => a.supportsAdoptingStyleSheets,
            svg: () => r.svg,
            unsafeCSS: () => a.unsafeCSS,
          });
        var i = n('./node_modules/lit-html/lib/shady-render.js'),
          s = n('./node_modules/lit-element/lib/updating-element.js'),
          o = n('./node_modules/lit-element/lib/decorators.js'),
          r = n('./node_modules/lit-html/lit-html.js'),
          a = n('./node_modules/lit-element/lib/css-tag.js');
        ...
        class d extends s.UpdatingElement {
          ...
          static _getUniqueStyles() {
            ...
            this._styles = this._styles.map((e) => {
              if (e instanceof CSSStyleSheet && !a.supportsAdoptingStyleSheets) {
                const t = Array.prototype.slice.call(e.cssRules).reduce((e, t) => e + t.cssText, '');
                return (0, a.unsafeCSS)(t);
              }
              return e;
            });
          }
          ...
          update(e) {
            const t = this.render();
            super.update(e),
              t !== l && this.constructor.render(t, this.renderRoot, { scopeName: this.localName, eventContext: this }),
        ...
        (d.finalized = !0), (d.render = i.render);
      },
      './node_modules/lit-html/lib/default-template-processor.js': (e, t, n) => {
        n.r(t), n.d(t, { DefaultTemplateProcessor: () => s, defaultTemplateProcessor: () => o });
        var i = n('./node_modules/lit-html/lib/parts.js');
        class s {
          handleAttributeExpressions(e, t, n, s) {
            const o = t[0];
            if ('.' === o) {
              return new i.PropertyCommitter(e, t.slice(1), n).parts;
            }
            return '@' === o
              ? [new i.EventPart(e, t.slice(1), s.eventContext)]
              : '?' === o
              ? [new i.BooleanAttributePart(e, t.slice(1), n)]
              : new i.AttributeCommitter(e, t, n).parts;
          }
      ...
      './node_modules/lit-html/lib/directive.js': (e, t, n) => {
        n.r(t), n.d(t, { directive: () => s, isDirective: () => o });
        const i = new WeakMap(),
          s =
            (e) =>
            (...t) => {
      ...
      './node_modules/lit-html/lib/dom.js': (e, t, n) => {
        n.r(t), n.d(t, { isCEPolyfill: () => i, removeNodes: () => o, reparentNodes: () => s });
          ...
          n.d(t, {
            insertNodeIntoTemplate: () =>
              function (e, t, n = null) {
                ...
                const l = document.createTreeWalker(i, s, null, !1);
                let d = r(a),
                  c = 0,
                  h = -1;
                for (; l.nextNode(); ) {
                  h++;
                  const e = l.currentNode;
                  for (e === n && ((c = o(t)), n.parentNode.insertBefore(t, n)); -1 !== d && a[d].index === h; ) {
                    if (c > 0) {
                      for (; -1 !== d; ) (a[d].index += c), (d = r(a, d));
                      return;
                    }
                    d = r(a, d);
                  }
            ...
            removeNodesFromTemplate: () =>
              function (e, t) {
                const {
                  ...
                  o = document.createTreeWalker(n, s, null, !1);
                let a = r(i),
                  l = i[a],
                  d = -1,
                  c = 0;
                ...
                for (; o.nextNode(); ) {
                  ...
                  for (e.previousSibling === p && (p = null), t.has(e) && (h.push(e), null === p && (p = e)), null !== p && c++; void 0 !== l && l.index === d; )
                    (l.index = null !== p ? -1 : l.index - c), (a = r(i, a)), (l = i[a]);
                }
                h.forEach((e) => e.parentNode.removeChild(e));
              },
          });
        var i = n('./node_modules/lit-html/lib/template.js');
        const s = 133;
        const o = (e) => {
          ...
          r = (e, t = -1) => {
            for (let n = t + 1; n < e.length; n++) {
              const t = e[n];
              if ((0, i.isTemplatePartActive)(t)) return n;
            }
            return -1;
          };
      },
      './node_modules/lit-html/lib/part.js': (e, t, n) => {
        n.r(t), n.d(t, { noChange: () => i, nothing: () => s });
        const i = {},
          s = {};
      },
      './node_modules/lit-html/lib/parts.js': (e, t, n) => {
              ...
              class {
                ...
                commit() {
                  ...
                  n && this.element.removeEventListener(this.eventName, this.__boundHandleEvent, this.__options),
                    s && ((this.__options = f(e)), this.element.addEventListener(this.eventName, this.__boundHandleEvent, this.__options)),
                    (this.value = e),
                    (this.__pendingValue = o.noChange);
                }
                handleEvent(e) {
        ...
        var i = n('./node_modules/lit-html/lib/directive.js'),
          s = n('./node_modules/lit-html/lib/dom.js'),
          o = n('./node_modules/lit-html/lib/part.js'),
          r = n('./node_modules/lit-html/lib/template-instance.js'),
          a = n('./node_modules/lit-html/lib/template-result.js'),
          l = n('./node_modules/lit-html/lib/template.js');
        const d = (e) => null === e || !('object' == typeof e || 'function' == typeof e),
        ...
        class h {
          ...
          _getValue() {
            ...
            for (let s = 0; s < t; s++) {
              ...
              if (void 0 !== t) {
                const e = t.value;
                if (d(e) || !c(e)) i += 'string' == typeof e ? e : String(e);
        ...
        class p {
          ...
          setValue(e) {
            e === o.noChange || (d(e) && e === this.value) || ((this.value = e), (0, i.isDirective)(e) || (this.committer.dirty = !0));
          }
          commit() {
            for (; (0, i.isDirective)(this.value); ) {
              const e = this.value;
        ...
        class u {
          ...
          appendInto(e) {
            (this.startNode = e.appendChild((0, l.createMarker)())), (this.endNode = e.appendChild((0, l.createMarker)()));
          }
          insertAfterNode(e) {
            (this.startNode = e), (this.endNode = e.nextSibling);
          }
          appendIntoPart(e) {
            e.__insert((this.startNode = (0, l.createMarker)())), e.__insert((this.endNode = (0, l.createMarker)()));
          }
          insertAfterPart(e) {
            e.__insert((this.startNode = (0, l.createMarker)())), (this.endNode = e.endNode), (e.endNode = this.startNode);
          }
          setValue(e) {
            this.__pendingValue = e;
          }
          commit() {
            ...
            e !== o.noChange &&
              (d(e)
                ...
                : e === o.nothing
                ? ((this.value = o.nothing), this.clear())
                : this.__commitText(e));
          }
          __insert(e) {
          ...
          __commitTemplateResult(e) {
            ...
            if (this.value instanceof r.TemplateInstance && this.value.template === t) this.value.update(e.values);
            else {
              const n = new r.TemplateInstance(t, e.processor, this.options),
                i = n._clone();
          ...
          __commitIterable(e) {
            ...
            let n,
              i = 0;
            for (const s of e)
              void 0 === (n = t[i]) && ((n = new u(this.options)), t.push(n), 0 === i ? n.appendIntoPart(this) : n.insertAfterPart(t[i - 1])),
                n.setValue(s),
                n.commit(),
                i++;
        ...
        const f = (e) => e && (v ? { capture: e.capture, passive: e.passive, once: e.once } : e.capture);
      },
      './node_modules/lit-html/lib/render.js': (e, t, n) => {
        n.r(t), n.d(t, { parts: () => r, render: () => a });
        var i = n('./node_modules/lit-html/lib/dom.js'),
          s = n('./node_modules/lit-html/lib/parts.js'),
          o = n('./node_modules/lit-html/lib/template-factory.js');
        const r = new WeakMap(),
          a = (e, t, n) => {
            let a = r.get(t);
            void 0 === a &&
              ((0, i.removeNodes)(t, t.firstChild), r.set(t, (a = new s.NodePart(Object.assign({ templateFactory: o.templateFactory }, n)))), a.appendInto(t)),
              a.setValue(e),
              a.commit();
          };
      },
      './node_modules/lit-html/lib/shady-render.js': (e, t, n) => {
        n.r(t), n.d(t, { TemplateResult: () => d.TemplateResult, html: () => d.html, render: () => v, shadyTemplateFactory: () => p, svg: () => d.svg });
        var i = n('./node_modules/lit-html/lib/dom.js'),
          s = n('./node_modules/lit-html/lib/modify-template.js'),
          o = n('./node_modules/lit-html/lib/render.js'),
          r = n('./node_modules/lit-html/lib/template-factory.js'),
          a = n('./node_modules/lit-html/lib/template-instance.js'),
          l = n('./node_modules/lit-html/lib/template.js'),
          d = n('./node_modules/lit-html/lit-html.js');
        const c = (e, t) => `${e}--${t}`;
        let h = !0;
        ...
        const p = (e) => (t) => {
            const n = c(t.type, e);
            let i = r.templateCaches.get(n);
            void 0 === i && ((i = { stringsArray: new WeakMap(), keyString: new Map() }), r.templateCaches.set(n, i));
            let s = i.stringsArray.get(t.strings);
            if (void 0 !== s) return s;
            const o = t.strings.join(l.marker);
            if (void 0 === (s = i.keyString.get(o))) {
              const n = t.getTemplateElement();
              h && window.ShadyCSS.prepareTemplateDom(n, e), (s = new l.Template(t, n)), i.keyString.set(o, s);
            }
          ...
          g = (e, t, n) => {
            ...
            const i = n ? n.element : document.createElement('template'),
              ...
              { length: a } = o;
            if (0 === a) return void window.ShadyCSS.prepareTemplateStyles(i, e);
            const l = document.createElement('style');
            for (let e = 0; e < a; e++) {
              const t = o[e];
              t.parentNode.removeChild(t), (l.textContent += t.textContent);
            }
            ((e) => {
              u.forEach((t) => {
                const n = r.templateCaches.get(c(t, e));
                void 0 !== n &&
            ...
            const d = i.content;
            n ? (0, s.insertNodeIntoTemplate)(n, l, d.firstChild) : d.insertBefore(l, d.firstChild), window.ShadyCSS.prepareTemplateStyles(i, e);
            const h = d.querySelector('style');
            if (window.ShadyCSS.nativeShadow && null !== h) t.insertBefore(h.cloneNode(!0), t.firstChild);
            else if (n) {
              d.insertBefore(l, d.firstChild);
              const e = new Set();
              e.add(l), (0, s.removeNodesFromTemplate)(n, e);
            }
          },
          v = (e, t, n) => {
            ...
            const s = n.scopeName,
              r = o.parts.has(t),
              l = h && 11 === t.nodeType && !!t.host,
              d = l && !m.has(s),
              c = d ? document.createDocumentFragment() : t;
            if (((0, o.render)(e, c, Object.assign({ templateFactory: p(s) }, n)), d)) {
              const e = o.parts.get(c);
              o.parts.delete(c);
              const n = e.value instanceof a.TemplateInstance ? e.value.template : void 0;
              g(s, c, n), (0, i.removeNodes)(t, t.firstChild), t.appendChild(c), o.parts.set(t, e);
            }
            !r && l && window.ShadyCSS.styleElement(t.host);
          };
      },
          ...
          n.d(t, {
            ...
            templateFactory: () =>
              function (e) {
                ...
                const o = e.strings.join(i.marker);
          ...
          n.d(t, {
            TemplateInstance: () =>
              class {
                ...
                _clone() {
                  const e = i.isCEPolyfill ? this.template.element.content.cloneNode(!0) : document.importNode(this.template.element.content, !0),
                    t = [],
                  ...
                  let r,
                    ...
                    d = o.nextNode();
                  for (; a < n.length; )
                    if (((r = n[a]), (0, s.isTemplatePartActive)(r))) {
                      for (; l < r.index; )
                        l++,
                          'TEMPLATE' === d.nodeName && (t.push(d), (o.currentNode = d.content)),
                          null === (d = o.nextNode()) && ((o.currentNode = t.pop()), (d = o.nextNode()));
                      if ('node' === r.type) {
                  ...
                  return i.isCEPolyfill && (document.adoptNode(e), customElements.upgrade(e)), e;
                }
              },
          });
        var i = n('./node_modules/lit-html/lib/dom.js'),
      ...
      './node_modules/lit-html/lib/template-result.js': (e, t, n) => {
        n.r(t), n.d(t, { SVGTemplateResult: () => l, TemplateResult: () => a });
        var i = n('./node_modules/lit-html/lib/dom.js'),
          s = n('./node_modules/lit-html/lib/template.js');
        const o = window.trustedTypes && trustedTypes.createPolicy('lit-html', { createHTML: (e) => e }),
          r = ` ${s.marker} `;
        class a {
          constructor(e, t, n, i) {
          ...
          getHTML() {
            ...
            for (let i = 0; i < e; i++) {
              ...
              const a = s.lastAttributeNameRegex.exec(e);
              t += null === a ? e + (n ? r : s.nodeMarker) : e.substr(0, a.index) + a[1] + a[2] + s.boundAttributeSuffix + a[3] + s.marker;
            }
          ...
          getTemplateElement() {
            ...
            let t = this.getHTML();
            return void 0 !== o && (t = o.createHTML(t)), (e.innerHTML = t), e;
          }
        }
        class l extends a {
          getHTML() {
          ...
          getTemplateElement() {
            const e = super.getTemplateElement(),
              t = e.content,
              n = t.firstChild;
            return t.removeChild(n), (0, i.reparentNodes)(t, n.firstChild), e;
          }
        }
      },
      './node_modules/lit-html/lib/template.js': (e, t, n) => {
        n.r(t),
          n.d(t, {
            Template: () =>
              class {
                constructor(e, t) {
                  ...
                  const n = [],
                    s = [],
                    l = document.createTreeWalker(t.content, 133, null, !1);
                  let h = 0,
                    p = -1,
                    u = 0;
                  const {
                      ...
                      if ((p++, 1 === e.nodeType)) {
                        if (e.hasAttributes()) {
                          const t = e.attributes,
                            { length: n } = t;
                          let i = 0;
                          for (let e = 0; e < n; e++) a(t[e].name, r) && i++;
                          for (; i-- > 0; ) {
                            const t = m[u],
                              n = c.exec(t)[2],
                              i = n.toLowerCase() + r,
                            ...
                            e.removeAttribute(i);
                            const a = s.split(o);
                            this.parts.push({ type: 'attribute', index: p, name: n, strings: a }), (u += a.length - 1);
                          }
                        }
                        'TEMPLATE' === e.tagName && (s.push(e), (l.currentNode = e.content));
                        ...
                        if (t.indexOf(i) >= 0) {
                          ...
                          for (let t = 0; t < l; t++) {
                            ...
                            if ('' === o) n = d();
                              ...
                              const e = c.exec(o);
                              null !== e && a(e[2], r) && (o = o.slice(0, e.index) + e[1] + e[2].slice(0, -r.length) + e[3]), (n = document.createTextNode(o));
                            }
                            i.insertBefore(n, e), this.parts.push({ type: 'node', index: ++p });
                          }
                          '' === s[l] ? (i.insertBefore(d(), e), n.push(e)) : (e.data = s[l]), (u += l);
                        }
                      } else if (8 === e.nodeType)
                        if (e.data === i) {
                          const t = e.parentNode;
                          (null !== e.previousSibling && p !== h) || (p++, t.insertBefore(d(), e)),
                            (h = p),
                          ...
                          let t = -1;
                          for (; -1 !== (t = e.data.indexOf(i, t + 1)); ) this.parts.push({ type: 'node', index: -1 }), u++;
                        }
            ...
            boundAttributeSuffix: () => r,
            createMarker: () => d,
            isTemplatePartActive: () => l,
      ...
      './node_modules/lit-html/lit-html.js': (e, t, n) => {
        n.r(t),
          n.d(t, {
            AttributeCommitter: () => l.AttributeCommitter,
            AttributePart: () => l.AttributePart,
            BooleanAttributePart: () => l.BooleanAttributePart,
            DefaultTemplateProcessor: () => i.DefaultTemplateProcessor,
            EventPart: () => l.EventPart,
            NodePart: () => l.NodePart,
            PropertyCommitter: () => l.PropertyCommitter,
            PropertyPart: () => l.PropertyPart,
            SVGTemplateResult: () => s.SVGTemplateResult,
            Template: () => p.Template,
            TemplateInstance: () => h.TemplateInstance,
            TemplateResult: () => s.TemplateResult,
            createMarker: () => p.createMarker,
            defaultTemplateProcessor: () => i.defaultTemplateProcessor,
            directive: () => o.directive,
            html: () => u,
            isDirective: () => o.isDirective,
            isIterable: () => l.isIterable,
            isPrimitive: () => l.isPrimitive,
            isTemplatePartActive: () => p.isTemplatePartActive,
            noChange: () => a.noChange,
            nothing: () => a.nothing,
            parts: () => d.parts,
            removeNodes: () => r.removeNodes,
            render: () => d.render,
            reparentNodes: () => r.reparentNodes,
            svg: () => m,
            templateCaches: () => c.templateCaches,
            templateFactory: () => c.templateFactory,
          });
        var i = n('./node_modules/lit-html/lib/default-template-processor.js'),
          s = n('./node_modules/lit-html/lib/template-result.js'),
          o = n('./node_modules/lit-html/lib/directive.js'),
          r = n('./node_modules/lit-html/lib/dom.js'),
          a = n('./node_modules/lit-html/lib/part.js'),
          l = n('./node_modules/lit-html/lib/parts.js'),
          d = n('./node_modules/lit-html/lib/render.js'),
          c = n('./node_modules/lit-html/lib/template-factory.js'),
          h = n('./node_modules/lit-html/lib/template-instance.js'),
          p = n('./node_modules/lit-html/lib/template.js');
        'undefined' != typeof window && (window.litHtmlVersions || (window.litHtmlVersions = [])).push('1.3.0');
        const u = (e, ...t) => new s.TemplateResult(e, t, 'html', i.defaultTemplateProcessor),
          m = (e, ...t) => new s.SVGTemplateResult(e, t, 'svg', i.defaultTemplateProcessor);
      },
    },
    t = {};
  function n(i) {
  ...
  (() => {
    n.r(i);
    var e = n('./node_modules/lit-element/lit-element.js');
    n('./src/styles/pdb-ligand-env.css');
    customElements.define(
      ...
      class extends e.LitElement {
        ...
        set contactType(e) {
          ...
          (this._contactType = e), t.length > 0 && this.renderLigandEnv();
        }
        get contactType() {
        ...
        renderLigandEnv() {
          ...
          let e = new Config.UIParameters();
          (e.zoom = this.zoomOn), (e.menu = void 0 !== this.pdbId);
          let t = void 0 === this.env ? 'production' : this.env,
            n = void 0 !== this.namesOn && this.namesOn;
          (this.display = new Visualization(this, e, t)),
            this.pdbId
              ? this.entityId
              ...
              : this.resName &&
                this.display.initLigandDisplay(this.resName, n).then(() => {
                  this.contactType &&
