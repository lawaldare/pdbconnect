...
export interface withMarginInterface extends NightingaleBaseElementAdam, WithDimensionsInterface {
  'margin-top': number;
...
declare const withMargin: <T extends Constructor<NightingaleBaseElementAdam>>(
  superClass: T,
  options?: {
    'margin-top'?: number;
    'margin-bottom'?: number;
